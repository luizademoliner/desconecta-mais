...
public class SessaoFocoController {
    ...
    public SessaoFocoResponseDto iniciar(@RequestBody @Valid IniciarSessaoFocoRequestDto dto,
    ...
    public SessaoFocoResponseDto cancelar(@PathVariable Long id,
